<?php
$reponame    = "My Repository - http://repo.ps2apps.com/";
$packagelist = "packages.txt";
$log         = "/var/sentora/logs/domains/zadmin/repo.ps2apps.com-access.log";
$ignoreip    = "125.239.45.179"; //I use this to ignore how many times I have downloaded anything from my own ip
