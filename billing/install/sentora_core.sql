...
(1, 'email.from', 'from@sentora.com', 'Email from', 'Emails from the system will be send from this email. '),
(2, 'email.fromname', 'Billing firm', 'Email from name', 'Your name will be showed as the sender. '),
(3, 'system.url_billing', 'http://billing.sentora.com', 'Billing url', 'The url to your billing website. '),
(4, 'system.url_sentora', 'sentora.sentora.com', 'sentora url', 'The url to the sentora'),
(5, 'system.firm', 'Firm', 'Firm', 'All email will be using this as a regards.  Eg. sentora'),
...
(8, 'email.contact_email', 'billing@sentora.com', 'Contact email', 'Your email the customer can contact you at. '),
...
(11, 'payment.notify_url', 'http://billing.sentora.com/ipn.php', 'IPN url', 'The url to your IPN file. If you are using my eg. is it http://your_uploaded_files.dk/ipn.php'),
...
(16, 'payment.logo', 'http://sentora.com/logo.png', 'Payment logo', 'eg. http://kagemand.dk/logo.png'),
(17, 'payment.email_paypal', 'bussiness.paypal@sentora.com', 'Paypal business email', 'The money will be "send" to this email. '),
(18, 'payment.email_error', 'error.paypal@sentora.com', 'Paypal error email', 'All errors from paypal will be send to this email. '),
(19, 'payment.return_url', 'http://sentora.com/billing-succes', 'Paypal return url', 'If you activate automatical return url from paypal, will the user be redirected to this url after payment success. '),
