...
$net2ftp_settings["email_feedback"] = "hostmater@localhost";
...
$net2ftp_settings["max_filesize"]  = "52428800";  // in Bytes, 50 Mb
...
$net2ftp_settings["max_consumption_ipaddress_datatransfer"] = 1000000000; // per IP address (1 Gb)
$net2ftp_settings["max_consumption_ftpserver_datatransfer"] = 25000000000; // per FTP server (25 Gb)

// Maximum script execution time per day (in seconds)
$net2ftp_settings["max_consumption_ipaddress_executiontime"] = 10800; // per IP address (3 hours)
$net2ftp_settings["max_consumption_ftpserver_executiontime"] = 86400; // per FTP server (24 hours)

// Maximum number of FTP servers that can be accessed per day
$net2ftp_settings["max_consumption_ipaddress_nr_of_ftpservers"] = 150; // per IP address
